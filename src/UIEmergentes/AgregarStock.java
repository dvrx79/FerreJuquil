 ...
 * @author salin
 */
public class AgregarStock extends javax.swing.JDialog {
     ...
     */
    public AgregarStock(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void definirCantidadMin(int n){
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Actualiza el Stock");
    ...
    private void btnCanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCanActionPerformed
        int cantObt = (int) spnCant.getValue();
        int cantfinal = cantObt + canac;
        System.out.println("obtenido "+cantfinal+" Codigo "+cod);

        try {
            mi.actualizarCantidadPorCodigo(cod, cantfinal);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AgregarStock dialog = new AgregarStock(new javax.swing.JFrame(), true);
