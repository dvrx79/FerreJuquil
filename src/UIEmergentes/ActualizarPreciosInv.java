 ...
 * @author salin
 */
public class ActualizarPreciosInv extends javax.swing.JDialog {
     ...
     */
    public ActualizarPreciosInv(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void CambiarNombre(String n, String codsec){
        System.out.println("se obtuvo "+n);
        lblNombre.setText(n);
        cod = codsec;
    }
    
    public void definirCantidadMin(float n){
        spnCant.setModel(new javax.swing.SpinnerNumberModel(n, n, null, 1));
        pcact = n;
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Actualiza el precio de compra actual");
        ...
        spnCant.setModel(new javax.swing.SpinnerNumberModel(1.0f, 1.0f, null, 1.0f));
        ...
        BtnALayout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, BtnALayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(btnAce, javax.swing.GroupLayout.DEFAULT_SIZE, 26, Short.MAX_VALUE)
                .addContainerGap())
        );
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(spnCant, javax.swing.GroupLayout.PREFERRED_SIZE, 157, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(51, 51, 51)
    ...
    private void btnCanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCanActionPerformed
        float cantObt = (float) spnCant.getValue();
        float costoVentaDecimal = calcularCostoVenta(cantObt, 0.16f, 0.30f);
        int costoVenta;

        if (costoVentaDecimal >= Math.floor(costoVentaDecimal) + 0.5) {
            costoVenta = (int) Math.ceil(costoVentaDecimal); // Redondear hacia arriba
        } else {
            costoVenta = (int) Math.floor(costoVentaDecimal); // Redondear hacia abajo
        }

    try {
        mi.actualizarCostoCompraPorCodigo(cod, cantObt, (float) costoVenta);
    ...
    public static float calcularCostoVenta(float costoCompra, float tasaIVA, float margenUtilidad) {
    return costoCompra * (1 + tasaIVA) * (1 + margenUtilidad);
}
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ActualizarPreciosInv.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ActualizarPreciosInv dialog = new ActualizarPreciosInv(new javax.swing.JFrame(), true);
