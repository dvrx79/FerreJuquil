 ...
 * @author salin
 */
public class BuscarClientesPV extends javax.swing.JDialog {
     ...
     */
    public BuscarClientesPV(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
if (filaSeleccionada != -1) {
    ...
    System.out.println("ID Buscar "+ idCliente);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BuscarClientesPV.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                BuscarClientesPV dialog = new BuscarClientesPV(new javax.swing.JFrame(), true);
